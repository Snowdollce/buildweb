    ...
    <section id="pricing-section" className="relative w-full bg-white py-16 md:py-24 border-b-4 border-[#412d17]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
          ...
          {/* CARD 1: DX-MGA (NEW) */}
          <div className="bg-[#fcfbf7] sketch-border-thick rounded-3xl p-6 sm:p-10 sketch-shadow-lg relative overflow-hidden flex flex-col justify-between rotate-[-1.5deg] hover:rotate-0 hover:scale-[1.01] transition-all">
          ...
          {/* CARD 2: DX-09 (EXISTING) */}
          <div className="bg-[#fbf8ee] sketch-border-thick rounded-3xl p-6 sm:p-10 sketch-shadow-lg relative overflow-hidden flex flex-col justify-between rotate-[1.5deg] hover:rotate-0 hover:scale-[1.01] transition-all">
